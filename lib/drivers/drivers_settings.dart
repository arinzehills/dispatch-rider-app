...
import 'package:dispacher_app/users/edit_user_detail.dart';

class DriversSettings extends StatefulWidget {
  @override
  _DriversSettingsState createState() => _DriversSettingsState();
}

class _DriversSettingsState extends State<DriversSettings> {
  String _currentName;
